...
def test(answer):
    ...
    function_answer = round(calculate_next_months_food([5, 7, 8], 12), 0)
    
    result = round(answer, 0) == function_answer
    
    print("Test Result: " + str(result))
    print("Function Answer: " + str(function_answer))
    print("Input Answer: " + str(answer))
